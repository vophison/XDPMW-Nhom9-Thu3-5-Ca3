...
<div class="inner-header">
    <div class="container">
        <div class="pull-left">
            <h6 class="inner-title">Sản phẩm Thuộc Loại {{$tenloai_sanpham->tenloai}}</h6>  <!-- lấy tên loại ra từ pagecontroller-->
        </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <ul class="aside-menu">
                        ...
                        <li><a href="{{route('loaisanpham',$item->maloai)}}">{{$item->tenloai}}</a></li>  <!-- vào route loaisanpham gọi biến -->
                        @endforeach
                    </ul>
                </div>
                <div class="col-sm-9">
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            @foreach ($sanpham_theoloai as $item)
                            <div class="col-sm-4">
